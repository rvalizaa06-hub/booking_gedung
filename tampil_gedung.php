...
?>
  ...
  <div class="d-flex justify-content-between align-items-center">
    <div>
      <h4 class="mb-1">
        <i class="fa fa-building mr-2"></i> Daftar Gedung
      </h4>
      <p class="mb-0">Berikut ini adalah daftar gedung yang tersedia</p>
    </div>
    <a href="gedung.php" class="btn btn-light btn-sm">
    ...
    <table class="table table-bordered table-striped table-hover text-center">
      ...
      ?>
        <tr>
          ...
          <td>
  <a href="edit_gedung.php?id_gedung=<?= $row['id_gedung']; ?>" 
     class="btn btn-info btn-sm">
     <i class="fa fa-edit"></i>
  </a>
  <a href="delete_gedung.php?id_gedung=<?= $row['id_gedung']; ?>" 
