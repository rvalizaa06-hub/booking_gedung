...
// proteksi login (konsisten dengan dashboard.php)
...
// =======================
$NAMA_PEMINJAM_DEFAULT = "Peminjam Baru";
...
/* samakan background dengan halaman Edit Gedung */
body {
  background: #fffde8ff;
}
...
?>
  ...
  <div class="d-flex justify-content-between align-items-center">
    <div>
      <h4 class="mb-1">
        <i class="fa fa-user mr-2"></i> Daftar Peminjam
      </h4>
      <p class="mb-0">Berikut ini adalah daftar peminjam gedung</p>
    </div>
    <a href="peminjam.php" class="btn btn-light btn-sm">
...
<div class="card card-table-custom">
  ...
  <div class="btn-group-aksi">
    <a href="edit_peminjam.php?id_peminjam=<?= $row['id_peminjam']; ?>"
       class="btn btn-info btn-sm">
      <i class="fa fa-edit"></i>
    </a>

    <a href="delete_peminjam.php?id_peminjam=<?= $row['id_peminjam']; ?>"
       class="btn btn-danger btn-sm"
       onclick="return confirm('Yakin hapus data peminjam ini?')">
